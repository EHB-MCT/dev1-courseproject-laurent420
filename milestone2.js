...
function drawRandomShapes(canvasId, imageId) {
    ...
    image.onload = () => {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            const shapeType = Math.random(); // Willekeurig kiezen tussen cirkel of vierkant
            ...
            if (shapeType < 0.25) {
                ...
                ctx.strokeStyle = `rgba(${Math.random()*255}, ${Math.random()*255}, ${Math.random()*255}, 0.5)`;  // Willekeurige lijnkleur
